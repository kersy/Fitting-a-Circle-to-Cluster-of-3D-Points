...
public class EllipseFittingdev {
    ...
    public static Ellipse EllipseFitting(double[][] Ecount)//椭圆拟合算法
    {
        ...
        Matrix M2 = new Matrix(M2t);
            ...
            ellipse.setEa(Math.max(a,b));
            ellipse.setEb(Math.min(a,b));
            ellipse.setOva((ellipse.getEa()-ellipse.getEb())/((ellipse.getEa()+ellipse.getEb()))*2000);
            return ellipse;
...
//
//                {	72632.2824	,	47836.7812	,	292.4664	},
//                {	72630.9403	,	47836.4604	,	293.8825	},
//                {	72630.4317	,	47836.3276	,	295.2579	},
//                {	72630.3857	,	47836.3381	,	296.7034	},
//                {	72630.8075	,	47836.4695	,	298.1027	},
////                {	72631.6149	,	47836.6907	,	299.217	},
//                {	72632.7981	,	47837.0016	,	300.0415	},
//                {	72636.1482	,	47837.8443	,	300.0772	},
//                {	72637.1453	,	47838.0825	,	299.4701	},
//                {	72638.6735	,	47838.4458	,	295.4761	},
//                {	72638.1767	,	47838.3051	,	293.9825	},
//                {	72637.3124	,	47838.0693	,	292.8761	},
//                {	72636.2022	,	47837.7679	,	292.1229	},
//                {	72634.235	,	47837.2675	,	291.7947	},
        ...
        Matrix P_yz = rodrigues_rot(P_center,normal,n2,1);//椭圆拟合向量
        P_yz.print(1,2);
        Ellipse ellipse = EllipseFitting(P_yz.getArray());//椭圆拟合完成
        //计算椭长短轴、圆度并输出
        System.out.println(ellipse.getEa()*2);
        System.out.println(ellipse.getEb()*2);
        System.out.println(ellipse.getOva());
    }
